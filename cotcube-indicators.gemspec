Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Lambda based indicators, decoupled from legacy cotcube}
  spec.description   = %q{Lambda based indicators, decoupled from legacy cotcube}

  spec.homepage      = %q{https://github.com/donkeybridge/cotcube-indicators}
